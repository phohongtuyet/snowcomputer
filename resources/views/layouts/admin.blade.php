...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('public/admin/vendors/typicons/typicons.css')}}">
  ...
  <link rel="stylesheet" href="{{ asset('public/admin/js/select.dataTables.min.css')}}">
  <!-- End plugin css for this page -->
  <!-- inject:css -->
  <link rel="stylesheet" href="{{ asset('public/admin/css/vertical-layout-light/style.css')}}">
  <!-- endinject -->
  <link rel="shortcut icon" href="{{ asset('public/admin/images/snowcomputer.png')}}">
        ...
        @else
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="order">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"><a class="nav-link" href="{{route('admin.donhang')}}">Đon hàng</a></li>
                </ul>
              </div>
            </li>
            ...
            <li class="nav-item nav-category">Hỗ trợ  </li>
            <li class="nav-item">
