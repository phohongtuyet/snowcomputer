    ...
    <div class="card-body table-responsive">
        ...
        <form action="{{ route('admin.lienhe.repkhuyenmai',['id' => $lienhe -> id]) }}" method="post">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control"  style="height: 100px" disabled>{{$lienhe->email}}</textarea>

            </div>

            <div class="mb-3">
                <label for="phanhoi" class="form-label  @error('phanhoi') is-invalid @enderror" value="{{ old('phanhoi') }}">Nội dung phản hồi</label>
